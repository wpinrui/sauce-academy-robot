export default class Help {
  ...
  static handler = async (bot, msg) => {
    ...
    await bot.sendMessage(msg.chat.id, "5. Last but not least, if you don't need a consultation and just want a quick explanation, do not hesitate to ask me @wpinrui directly :)");
  };
}
